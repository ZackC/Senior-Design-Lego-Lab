...
function display()
{
	...
	$stations = mysqli_query($con, "SELECT station_id FROM station WHERE cell = 1 AND station = 0");
	...
	<tr>
	<td>Lead Time: ' . $infoRow['takt_time'] . '</td>
	<td>Bottleneck Station: ' . $infoRow['bottleneck'] . '</td>
	</tr>
	</table>
	<p class="centeredImage"><img src="../../GUIGraphs/Cell1OverallProcessGraph.png" src="" width="60%" height="40%" alt="Process Times"></p>
	<p class="centeredImage"><img src="../../GUIGraphs/Cell1OverallIdleGraph.png" src="" width="60%" height="40%" alt="Idle Times"></p>';
}
?>
<!-- InstanceEndEditable -->
...
<div data-role="page">
	...
	<!-- InstanceBeginEditable name="header" -->
    	<a href="Cell1Overview.php" data-rel="back" data-icon="back">Back</a>
        <h1>Tiger Automotive Lab: Cell 1 Overall</h1>
	<!-- InstanceEndEditable -->
    </div>
