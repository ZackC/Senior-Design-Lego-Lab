...
function display()
{
	...
	<p class="centeredImage"><img src="../../GUIGraphs/Cell2Station4ProcessGraph" src="" width="60%" height="40%" alt="Process Times"></p>
	<p class="centeredImage"><img src="../../GUIGraphs/Cell2Station4IdleGraph" src="" width="60%" height="40%" alt="Idle Times"></p>';
}
?>
<!-- InstanceEndEditable -->
