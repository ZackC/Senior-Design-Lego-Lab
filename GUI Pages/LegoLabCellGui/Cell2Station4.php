...
function display()
{
	...
	$stations = mysqli_query($con, "SELECT station_id FROM station WHERE cell = 2 AND station = 4");
	...
	<p class="centeredImage"><img src="../../GUIGraphs/Cell2Station4ProcessGraph.png" src="" width="60%" height="40%" alt="Process Times"></p>
	<p class="centeredImage"><img src="../../GUIGraphs/Cell2Station4IdleGraph.png" src="" width="60%" height="40%" alt="Idle Times"></p>';
}
?>
<!-- InstanceEndEditable -->
...
<div data-role="page">
	...
	<!-- InstanceBeginEditable name="header" -->
    	<a href="Cell2Overview.php" data-rel="back" data-icon="back">Back</a>
        <h1>Tiger Automotive Lab: Cell 2 Station 4</h1>
	<!-- InstanceEndEditable -->
    </div>
