...
function display()
{
	...
	$stations = mysqli_query($con, "SELECT station_id FROM station WHERE cell = 3 AND station = 1");
...
<div data-role="page">
	...
	<!-- InstanceBeginEditable name="headerInfo" -->
        ...
        <h1>Tiger Automotive Lab: Cell 3 Station 1</h1>
	<!-- InstanceEndEditable -->
    </div>
