...
function display()
{
	...
	$stations = mysqli_query($con, "SELECT station_id FROM station WHERE cell = 3 AND station = 5");
	...
	<p class="centeredImage"><img src="../../GUIGraphs/Cell3Station5ProcessGraph.png" src="" width="60%" height="40%" alt="Process Times"></p>
	<p class="centeredImage"><img src="../../GUIGraphs/Cell3Station5IdleGraph.png" src="" width="60%" height="40%" alt="Idle Times"></p>';
}
?>
<!-- InstanceEndEditable -->
...
<div data-role="page">
	...
	<!-- InstanceBeginEditable name="header" -->
        ...
        <h1>Tiger Automotive Lab: Cell 3 Station 5</h1>
	<!-- InstanceEndEditable -->
    </div>
