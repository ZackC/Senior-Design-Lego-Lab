...
function display()
{
	...
	$stations = mysqli_query($con, "SELECT station_id FROM station WHERE cell = 3 AND station = 2");
	...
	<p class="centeredImage"><img src="../../GUIGraphs/Cell3Station2ProcessGraph.png" src="" width="60%" height="40%" alt="Process Times"></p>
	<p class="centeredImage"><img src="../../GUIGraphs/Cell3Station2IdleGraph.png" src="" width="60%" height="40%" alt="Idle Times"></p>';
}
?>
<!-- InstanceEndEditable -->
...
<div data-role="page">
	...
	<!-- InstanceBeginEditable name="header" -->
        ...
        <h1>Tiger Automotive Lab: Cell 3 Station 2</h1>
	<!-- InstanceEndEditable -->
    </div>
