...
function display()
{
	...
	$stations = mysqli_query($con, "SELECT station_id FROM station WHERE cell = 2 AND station = 0");
...
<div data-role="page">
	...
	<!-- InstanceBeginEditable name="header" -->
        ...
        <h1>Tiger Automotive Lab: Cell 2 Overall</h1>
	<!-- InstanceEndEditable -->
    </div>
