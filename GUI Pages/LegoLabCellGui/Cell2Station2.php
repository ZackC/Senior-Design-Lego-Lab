...
function display()
{
	...
	<p class="centeredImage"><img src="../../GUIGraphs/Cell2Station2ProcessGraph" src="" width="60%" height="40%" alt="Process Times"></p>
	<p class="centeredImage"><img src="../../GUIGraphs/Cell2Station2IdleGraph" src="" width="60%" height="40%" alt="Idle Times"></p>';
}
?>
<!-- InstanceEndEditable -->
