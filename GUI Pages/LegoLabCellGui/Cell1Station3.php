...
function display()
{
	...
	$stations = mysqli_query($con, "SELECT station_id FROM station WHERE cell = 1 AND station = 3");
	...
	<p class="centeredImage"><img src="../../GUIGraphs/Cell1Station3ProcessGraph.png" src="" width="60%" height="40%" alt="Process Times"></p>
	<p class="centeredImage"><img src="../../GUIGraphs/Cell1Station3IdleGraph.png" src="" width="60%" height="40%" alt="Idle Times"></p>';
}
?>
<!-- InstanceEndEditable -->
...
<div data-role="page">
	...
	<!-- InstanceBeginEditable name="header" -->
        ...
        <h1>Tiger Automotive Lab: Cell 1 Station 3</h1>
	<!-- InstanceEndEditable -->
    </div>
