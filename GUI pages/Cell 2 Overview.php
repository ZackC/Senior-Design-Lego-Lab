...
<body>
<div data-role="page" id="Cell 2 Overview">
	...
	<div data-role="content">
	  <table class="stationOverview">
	    <tr>
	      <td>
          <a href="Cell 2 Overall.php" rel="external" data-role="button">
          <table class="station">
            <tr>
              <td><h2 align="left">Overall:</h2>
	      ...
	      <td>
          <a href="Cell 2 Station 1.php" rel="external" data-role="button">
          <table class="station">
            <tr>
	    ...
	    <tr>
	      <td>
          <a href="Cell 2 Station 2.php" rel="external" data-role="button">
          <table class="station">
            <tr>
	      ...
	      <td>
          <a href="Cell 2 Station 3.php" rel="external" data-role="button">
          <table class="station">
            <tr>
	    ...
	    <tr>
	      <td>
          <a href="Cell 2 Station 4.php" rel="external" data-role="button">
          <table class="station">
            <tr>
	      ...
	      <td>
          <a href="Cell 2 Station 5.php" rel="external" data-role="button">
          <table class="station">
            <tr>
